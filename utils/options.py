...
# model
parser.add_argument("-model", type=str, choices=['CNN', 'MultiCNN', 'ResCNN', 'MultiResCNN','MultiHeadCNN','Dense_CNN','TCN','Ehr_Dense','ResDenseCNN', 'bert_seq_cls'], default='MultiResCNN')
